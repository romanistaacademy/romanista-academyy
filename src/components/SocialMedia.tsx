    ...
    <section className="py-20 bg-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-16 p-8 bg-gradient-to-r from-red-600/20 to-orange-600/10 border border-red-600/30 rounded-2xl"
        >
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-2">ذا خبرة</p>
            </div>
            <div>
              <p className="text-3xl font-black bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">
                📸 🎥
              </p>
              <p className="text-gray-400 mt-2">صور وفيديوهات يومية</p>
            </div>
          </div>
        </motion.div>
      </div>
