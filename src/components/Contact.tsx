...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 bg-gradient-to-b from-black to-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="p-8 bg-gradient-to-br from-red-600/20 to-orange-600/10 border border-red-600/40 rounded-2xl hover:border-red-500/60 transition-all duration-300 text-center"
              >
        ...
        <motion.div
          ...
          className="p-8 bg-gradient-to-r from-red-600/20 to-orange-600/10 border border-red-600/30 rounded-2xl text-center"
        >
