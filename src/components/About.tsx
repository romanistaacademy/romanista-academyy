      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full h-96 bg-gradient-to-br from-red-600/30 to-orange-600/20 rounded-2xl border border-red-600/50 overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 via-transparent to-orange-600/10 group-hover:from-red-600/30 transition-all duration-500" />
          ...
          {achievements.map((achievement, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="p-6 bg-gradient-to-br from-red-600/10 to-orange-600/10 border border-red-600/30 rounded-xl hover:border-red-500/60 transition-all duration-300 text-center"
              >
