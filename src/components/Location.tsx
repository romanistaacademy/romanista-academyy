...
export default function Location() {
  ...
  return (
    <section id="location" ref={ref} className="py-20 bg-gradient-to-b from-black to-red-950/20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="p-8 bg-gradient-to-br from-red-600/20 to-yellow-600/10 border border-red-600/40 rounded-2xl hover:border-red-500/60 transition-all duration-300"
          >
        ...
        <motion.div
          ...
          className="mt-12 p-8 bg-gradient-to-r from-red-600/20 to-yellow-600/10 border border-red-600/30 rounded-2xl"
        >
