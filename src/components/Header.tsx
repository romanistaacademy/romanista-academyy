    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          >
            {/* Academy Logo - Transparent Background with White Elements */}
            <div className="w-12 h-12 flex items-center justify-center shadow-lg filter drop-shadow-lg">
              <img 
            ...
            <div className="text-center hidden sm:block">
              <p className="text-sm font-bold text-white leading-tight">ROMANISTA</p>
