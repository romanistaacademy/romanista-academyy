...
export default function AgeGroups() {
  ...
  return (
    <section id="age-groups" ref={ref} className="py-20 bg-gradient-to-b from-black to-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {ageGroups.map((age, index) => (
            ...
            >
              <div className="relative p-6 bg-gradient-to-br from-red-600/20 to-orange-600/10 border border-red-600/40 rounded-xl text-center hover:border-red-500/80 hover:from-red-600/30 hover:to-orange-600/20 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative z-10">
                  <p className="text-3xl font-black text-transparent bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text group-hover:from-orange-500 group-hover:to-red-500 transition-all duration-300">
                    {age}
                  </p>
        ...
        <motion.div
          ...
          className="mt-16 p-8 bg-gradient-to-r from-red-600/20 to-orange-600/10 border border-red-600/30 rounded-2xl text-center"
        >
