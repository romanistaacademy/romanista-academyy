  ...
  return (
    <footer className="bg-black border-t border-red-600/30">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-red-600 to-yellow-500 rounded-lg flex items-center justify-center font-bold text-white">
                R
              </div>
              <div>
          ...
          <div className="flex gap-4">
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="w-10 h-10 bg-gradient-to-br from-red-600/30 to-yellow-600/10 border border-red-600/40 rounded-lg flex items-center justify-center text-xl hover:border-red-500/60 transition-all duration-300"
                title="Social Media"
              >
                {social.icon}
              </motion.a>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        href="#hero"
        className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-br from-red-600 to-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-xl hover:shadow-lg hover:shadow-red-600/50 transition-all duration-300 z-40"
        title="العودة للأعلى"
      >
        ↑
      </motion.a>
