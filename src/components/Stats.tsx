...
export default function Stats() {
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-b from-black via-red-950/20 to-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              <p className="text-4xl md:text-5xl font-black bg-gradient-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent mb-2">
